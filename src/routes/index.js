...
import VerticalBPChartSecond from '../containers/VerticalBPChartSecond';
import VerticalBPChartThird from '../containers/VerticalBPChartThird';
import VerticalBPChartForth from '../containers/VerticalBPChartForth';
import VerticalBPChartFifth from '../containers/VerticalBPChartFifth';
...
export const ContentRoute = () =>
  <Switch>
    ...
    <Route exact path='/vertical-bp-chart-second' component={VerticalBPChartSecond} />
    <Route exact path='/vertical-bp-chart-third' component={VerticalBPChartThird} />
    <Route exact path='/vertical-bp-chart-forth' component={VerticalBPChartForth} />
    <Route exact path='/vertical-bp-chart-fifth' component={VerticalBPChartFifth} />
