...
const RootBreadcrumb = ({match}) => {
  ...
  const names = {
    ...
    'vertical-bp-chart': '2015下到2016上',
    'vertical-bp-chart-second': '2016上到2016下',
    'vertical-bp-chart-third': '2016下到2017上',
    'vertical-bp-chart-forth': '2017上到2017下',
    'vertical-bp-chart-fifth': '2017下到2018上',
